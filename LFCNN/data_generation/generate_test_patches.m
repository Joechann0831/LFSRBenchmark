...
set_names = {'buddha','buddha2','coneHead','medieval','monasRoom','papillon','rx_elephant','rx_watch','statue','stillLife'};
...
for scale = 2:3
    ...
    for ds = 1:2
        ...
        for set_ind = 1:length(set_names)
            ...
            folder = ['../data/HCI/',set_name,'.mat'];
            save_folder = ['/media/joechan/Standby/LFVDSR/Data_LFVDSR/test/HCI/test_LFVDSR_',set_name,'_scale',num2str(scale),'_',ds_method,'.mat'];
